...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg-glow.g2 { background: #9146FF; bottom: -200px; right: -200px; animation-delay: -6s; }
        ...
        .btn-twitch:hover { box-shadow: 0 12px 32px rgba(145,70,255,0.5); }

        .btn-icon { width: 24px; height: 24px; flex-shrink: 0; fill: white; }
        .btn-text { flex: 1; }
        ...
        .info { margin-top: 32px; padding-top: 24px; border-top: 1px solid var(--border); }
        .info-title {
            font-family: 'Syne', sans-serif;
            font-size: 11px;
            font-weight: 700;
...
<div class="card">
    ...
    <p class="subtitle">
        Inicia sesión de forma segura usando tu cuenta de Discord o Twitch.
    ...
    {{-- Botón Twitch --}}
    <a href="{{ route('oauth.redirect', 'twitch') }}" class="btn btn-twitch">
        <svg class="btn-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714z"/>
        </svg>
        <span class="btn-text">Continuar con Twitch</span>
        <span class="btn-arrow">→</span>
    </a>
